        ...
        if (conexion != null) {
            try {
                ...
                if (resultado.next()) {
                    ...
                    estudiante.setApellidoPaterno(resultado.getString("estudiante.apellido_paterno"));
                    estudiante.setApellidoMaterno(resultado.getString("estudiante.apellido_materno"));
                    estudiante.setIdProyecto(resultado.getInt("estudiante.id_proyecto"));
                    estudiante.setIdExperienciaEducativa(resultado.getInt("estudiante.id_experiencia_educativa"));
