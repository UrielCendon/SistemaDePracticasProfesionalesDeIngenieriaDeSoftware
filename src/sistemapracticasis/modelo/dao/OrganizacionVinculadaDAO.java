...
public class OrganizacionVinculadaDAO {
    ...
    public static OrganizacionVinculada obtenerOrganizacionVinculadaPorEstudiante(int idEstudiante) {
        ...
        try (Connection conn = ConexionBD.abrirConexion();
            ...
            Utilidad.mostrarAlertaSimple(Alert.AlertType.ERROR, "Error de Base de Datos", "Ocurrió un error con la base de datos.");
        }
    ...
    public static List<OrganizacionVinculada> obtenerOrganizaciones() {
        ...
        String consulta = "SELECT id_organizacion_vinculada, razon_social, telefono, direccion, correo FROM organizacion_vinculada";
        ...
        try (Connection conexion = ConexionBD.abrirConexion();
            ...
            while (resultado.next()) {
                ...
                organizacion.setIdOrganizacionVinculada(resultado.getInt("id_organizacion_vinculada"));
                organizacion.setRazonSocial(resultado.getString("razon_social"));
    ...
    public static OrganizacionVinculada obtenerOrganizacionPorId(int idOrganizacion) {
        OrganizacionVinculada organizacion = null;
        String consulta = "SELECT id_organizacion_vinculada, razon_social, telefono, direccion, correo FROM organizacion_vinculada WHERE id_organizacion_vinculada = ?";
