...
public class ProyectoDAO {
    ...
    public static Proyecto obtenerProyectoPorIdEstudiante(int idEstudiante) {
        ...
        try (Connection conexion = ConexionBD.abrirConexion();
            ...
            Utilidad.mostrarAlertaSimple(javafx.scene.control.Alert.AlertType.ERROR, "ErrorDB", "Error con la base de datos");
        }
        return proyecto;
    }
    ...
    public static ResultadoOperacion registrarProyecto(Proyecto proyecto) {
        ...
        String consulta = "INSERT INTO proyecto (nombre, descripcion, estado, cupo, fecha_inicio, fecha_fin, id_organizacion_vinculada, id_responsable_proyecto) "
            + "VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    public static ArrayList<Proyecto> obtenerTodosLosProyectos() throws SQLException {
        ArrayList<Proyecto> listaProyectos = new ArrayList<>();
        String consulta = "SELECT id_proyecto, nombre, descripcion, estado, cupo, fecha_inicio, fecha_fin, id_organizacion_vinculada, id_responsable_proyecto FROM proyecto";
    ...
    public static ResultadoOperacion actualizarProyecto(Proyecto proyecto) {
        ResultadoOperacion resultado = new ResultadoOperacion();
        String consulta = "UPDATE proyecto SET nombre = ?, descripcion = ?, estado = ?, cupo = ?, fecha_inicio = ?, fecha_fin = ?, id_organizacion_vinculada = ?, id_responsable_proyecto = ? WHERE id_proyecto = ?";
